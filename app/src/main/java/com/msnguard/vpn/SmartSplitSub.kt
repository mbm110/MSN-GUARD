...
object SmartSplitSub {
     ...
     *
     * Order is the publisher's fallback ladder: fragA before fragB. The caller
     * races them cheapest-first and stops at the first that carries a blocked
     * SNI — see [ShardManager.startSmartSplit].
     *
