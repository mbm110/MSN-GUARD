...
Psiphon با یک نردبان سه‌پله‌ای اجرا می‌شود که بر اساس **زمان واقعیِ اتصال روی اپراتور خصمانه** مرتب شده. این ترتیب همان چیزی نیست که پیش‌فرض‌های خود Psiphon می‌دهند، و تفاوتش هم جزئی نیست.
